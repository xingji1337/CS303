I could not get the class to work, so I wrote down all the logic in the source.It runs automatically, just start it and it should create a map container
